...
export function AdditionalDeliveryCreateModal({
  opened,
  purchaseOrder,
  isLoading = false,
  onClose,
  onConfirm,
}: AdditionalDeliveryCreateModalProps) {
    ...
    <Stack gap="md">
      ...
      <Group justify="flex-end" gap="sm">
        ...
        <Button
          ...
          color="blue"
        >
          {t('delivery.createAdditionalDeliveryRequest')}
        </Button>
      </Group>
    </Stack>
  );
  ...
  if (isMobile) {
    return (
      <Drawer
        opened={opened}
        onClose={onClose}
        title={t('delivery.createAdditionalDeliveryRequest')}
        position="bottom"
        size="auto"
        padding="md"
      >
