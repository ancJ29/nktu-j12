...
const mockStaff: Staff[] = [
  {
    ...
    clockInUrl:
      'https://app.cMngt.com/clock-in/5d41402abc4b2a76b9719d911017c592/e4da3b7fbbce2345d7772b0674a318d5',
    clockInQrCode: '',
  ...
  },
  {
    ...
    clockInUrl:
      'https://app.cMngt.com/clock-in/5d41402abc4b2a76b9719d911017c592/f5ca38f748a1d6eaf726b8a42fb575c3',
    clockInQrCode: '',
  ...
  },
  {
    ...
    clockInUrl:
      'https://app.cMngt.com/clock-in/c1f4b5fb265066db8e9c028e7dc4e3a5/a8c5f1e8a1b1dc3d3e63a8b47fd2c872',
    clockInQrCode: '',
    workingPattern: 'shift',
  ...
  },
  {
    ...
    clockInUrl:
      'https://app.cMngt.com/clock-in/c1f4b5fb265066db8e9c028e7dc4e3a5/b6d767d2f8ed5d21a44b0e5886680cb9',
    clockInQrCode: '',
    workingPattern: 'fulltime',
    weeklyContractedHours: 40,
    defaultWeeklyHours: 40,
  ...
  },
  {
    ...
    clockInUrl:
      'https://app.cMngt.com/clock-in/d2a84f4b8b650937ec8f73cd8be2c4a4/c74d97b01eae257e44aa9d5bade97baf',
    clockInQrCode: '',
    workingPattern: 'shift',
  ...
  },
  {
    ...
    clockInUrl:
      'https://app.cMngt.com/clock-in/d2a84f4b8b650937ec8f73cd8be2c4a4/16790e0e170c3fcec02df1d6cb0bde6e',
    clockInQrCode: '',
    workingPattern: 'fulltime',
    weeklyContractedHours: 40,
    defaultWeeklyHours: 40,
  ...
  },
  {
    ...
    clockInUrl:
      'https://app.cMngt.com/clock-in/e358efa489f58062f10dd7316b65649e/e96ed478dab8595a7dbda4cbcbfb82ed',
    clockInQrCode: '',
    workingPattern: 'shift',
  ...
  },
  {
    ...
    clockInUrl:
      'https://app.cMngt.com/clock-in/1385974ed5904a438616ff7bdb3f7439/f0b9ec9d9a84ea7cc6cac11c3ba39cea',
    clockInQrCode: '',
    workingPattern: 'fulltime',
    weeklyContractedHours: 40,
    defaultWeeklyHours: 40,
...
const generateClockInUrl = (storeId: string, staffId: string): string => {
  ...
  return `https://app.cMngt.com/clock-in/${storeHash}/${staffHash}`;
};
