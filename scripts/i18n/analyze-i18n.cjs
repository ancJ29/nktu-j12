...
function analyzeI18n() {
  ...
  const flattenedPath = path.join(__dirname, 'en-flattened.json');
  fs.writeFileSync(flattenedPath, JSON.stringify(flattenedTranslations, null, 2));
  console.log(`   ✓ Saved to: ${flattenedPath}\n`);
